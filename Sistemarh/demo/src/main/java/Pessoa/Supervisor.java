...
public class Supervisor extends Funcionario implements Calculos {
    ...
    public Supervisor(String nome2, String data_nascimento, int idade, String cargo, String ctps, double salario,
            String estado) {
    }
    public ArrayList<Supervisor> getLista_Supervisor() {
          return lista_Supervisor;
     }
     public static void setLista_Supervisor(ArrayList<Supervisor> lista_Supervisor) {
          Supervisor.lista_Supervisor = lista_Supervisor;
     }
     private static ArrayList<Supervisor> lista_Supervisor = new ArrayList<>();
