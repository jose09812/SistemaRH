...
public class Gerente extends Funcionario implements Calculos {
    ...
    public Gerente(String nome, String data_nascimento, int idade, String cargo, String ctps, double salario,
               String estado) {
     }
public static ArrayList<Gerente> getLista_Gerente() {
          return lista_Gerente;
     }
     public static void setLista_Gerente(ArrayList<Gerente> lista_Gerente) {
          Gerente.lista_Gerente = lista_Gerente;
     }
     private static ArrayList <Gerente> lista_Gerente = new ArrayList<>();
